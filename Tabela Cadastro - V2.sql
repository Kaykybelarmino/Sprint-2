...
cargo CHAR(12) not null constraint chkCargo check(cargo in('gerente','colaborador')),
...
(null,'Cool plant','alface e rucula','colaborador','Carla','coolplant@gmail.com','1196444946'),
(null,'Arvore da vida','alface','gerente','Marcos','arvoredavida@gmail.com','1194915665'),
(null,'O hortifruti','alface e rucula','colaborador','Gerivaldo','ohortifruti@gmail.com','1194915665'),
(null,'bertonili','rucula','gerente','alberto','bertonili@gmail.com','1192675926');
SELECT * FROM cadastro;
UPDATE cadastro SET mercado = 'Carrefour'
       WHERE idCadastro = 4;
SELECT * FROM cadastro;
